...
enum DefaultMessageIDTypes
{
	...
	ID_REPLICA_MANAGER_DESTRUCTION,	//40
	...
	ID_CONNECTION_GRAPH_DISCONNECTION_NOTIFICATION,	//50
	...
	ID_DATABASE_INCORRECT_PASSWORD,	//80
	...
	ID_FILE_LIST_REFERENCE_PUSH,	//90
